          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            {error && (
              <motion.div
                ...
                className="bg-red-50 border border-red-200 text-red-600 rounded-md p-4 text-sm"
              >
                {error}
              </motion.div>
            )}
            ...
            <div>
              ...
              <div className="mt-1">
                <input
                  ...
                  className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-[#0052CC] focus:border-[#0052CC] sm:text-sm"
                />
              </div>
            </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input
                  ...
                  name="remember-me"
                  type="checkbox"
                  className="h-4 w-4 text-[#0052CC] focus:ring-[#0052CC] border-gray-300 rounded"
                />
              ...
              <div className="text-sm">
                <Link to="/forgot-password" className="font-medium text-[#0052CC] hover:text-[#0747A6]">
